...
effects <- list(c(0.9, 70, 0.04, 0.8, 100, 100),
                c(0.7, 70, 0.04, 0.8, 100, 100),
                c(0.5, 70, 0.04, 0.8, 100, 100),
                c(0.9, 40, 0.04, 0.8, 100, 100),
                c(0.7, 40, 0.04, 0.8, 100, 100),
                c(0.5, 40, 0.04, 0.8, 100, 100),
                
                c(0.5, 70, 0.04, 0.8, 100, 500))
